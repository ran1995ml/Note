...
CERT_DIR="/opt/cert"
CA_PEM="/opt/cert/ca.pem"
CA_CSR="/opt/cert/ca-csr.json"
CA_CONFIG="/opt/cert/ca-config.json"
ETCD_PEER_CSR="/opt/cert/etcd-peer-csr.json"
CLIENT_CSR="/opt/cert/client-csr.json"
APISERVER_CSR="/opt/cert/apiserver-csr.json"
KUBELET_CSR="/opt/cert/kubelet-csr.json"
KUBE_PROXY_CSR="/opt/cert/kube-proxy-csr.json"
