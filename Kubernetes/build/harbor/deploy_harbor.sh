...
sed -i "s/port: 80/port: 180/g" $HARBOR_YAML
sed -i "s#data_volume: /data#data_volume: /data/harbor#g" $HARBOR_YAML
sed -i "s#location: /var/log/harbor#location: /data/harbor/logs#g" $HARBOR_YAML
